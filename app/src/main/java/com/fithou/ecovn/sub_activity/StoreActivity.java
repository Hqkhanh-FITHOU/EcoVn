    ...
    private void setAppbarAnimation() {
        ...
        Palette.from(bitmap).generate(new Palette.PaletteAsyncListener() {
            ...
            public void onGenerated(@Nullable Palette palette) {
                collapsingToolbarLayout.setContentScrimColor(ContextCompat.getColor(StoreActivity.this,R.color.white ));
                collapsingToolbarLayout.setStatusBarScrimColor(ContextCompat.getColor(StoreActivity.this,R.color.Sauvignon_red));
            }
        });
    }
